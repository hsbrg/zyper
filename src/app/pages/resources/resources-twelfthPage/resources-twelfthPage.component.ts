...
export class ResourcesTwelfthComponent implements OnInit {
  ...
  private updateMetaTags(): void {
    ...
    if (
      currentRoute ===
      '/ai-marketing-resources/ultimate-guide-to-user-generated-content-ugc-for-business-growth'
    ) {
      this.setPageTitle(
        'Ultimate Guide to User-Generated Content (UGC) for Business Growth | Zyper AI'
      );
      this.setMetaTags(
        'Boost your business growth with user-generated content. Learn strategies to leverage UGC for enhanced brand engagement and visibility.',
        'user-generated content, UGC strategies, business growth, brand engagement, marketing tips'
      );
    }
  }
